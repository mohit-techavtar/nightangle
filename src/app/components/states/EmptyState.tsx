        ...
        <div className="flex items-center gap-3 flex-wrap justify-center">
          {primaryButton && (
            <button
              ...
              className="px-4 h-10 rounded-[6px] bg-[#1565C0] text-white text-sm font-medium hover:bg-[#0D47A1] transition-colors flex items-center gap-2"
            >
              {primaryButton.icon && <primaryButton.icon size={16} />}
              {primaryButton.label}
            </button>
          )}
